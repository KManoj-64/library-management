...
import { LayoutDashboard, Book, Users, ClipboardList, LogOut, Menu, X, Library } from 'lucide-react';
      ...
      >
        <div className="h-16 flex items-center px-6 border-b border-gray-800 bg-gray-950 shrink-0">  
          <Link to="/" className="flex items-center gap-3">
            ...
            <span className="text-xl font-bold tracking-tight text-white">AdminPortal</span>
          </Link>
          <button 
        ...
        <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4 sm:px-6 shrink-0 relative z-10 shadow-sm">
          ...
          <div className="flex items-center gap-3">
            <div className="hidden md:flex flex-col items-end mr-2">
              ...
              <span className="text-xs font-semibold px-2 py-0.5 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-full mt-1">Admin</span>
            </div>
